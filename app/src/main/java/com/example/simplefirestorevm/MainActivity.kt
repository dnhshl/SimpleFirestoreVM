    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        return when (item.itemId) {
            ...
            R.id.action_filter_data -> {
                findNavController(R.id.nav_host_fragment_content_main).navigate(R.id.filterDataFragment)
                true
            }
            R.id.action_enter_data -> {
                findNavController(R.id.nav_host_fragment_content_main).navigate(R.id.enterDataFragment)
                true
            }
